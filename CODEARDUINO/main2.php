...
void loop() {
  ...
  humValue = ((humMSB << 8) | humLSB) * 0.00190735 - 6;  // Convierte los bytes en la humedad en porcentaje
  ...
  // Convierte el objeto JSON a una cadena de caracteres y la envía por la comunicación serial
  serializeJson(jsonDoc, Serial);
  Serial.println();

  delay(1000);  // Espera 1 segundo antes de leer de nuevo los sensores y actualizar el objeto JSON
}
