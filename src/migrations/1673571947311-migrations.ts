...
export class migrations1673571947311 implements MigrationInterface {
    name = 'migrations1673571947311'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`garden\` ADD CONSTRAINT \`FK_fa938952111a2b1053fcf8bbdcf\` FOREIGN KEY (\`schedule_id\`) REFERENCES \`schedule\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
